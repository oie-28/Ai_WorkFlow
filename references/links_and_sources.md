# Links & Sources — แหล่งอ้างอิงโปรเจกต์
...
- `02-general-first-app.md` — สร้าง App แรก (Create→Build→Run, Capture element ด้วย Ctrl+คลิก)
- `03-lesson1-web-automation.md` — 7 คำสั่งส่ง WhatsApp + วิธี Record (F4)

## หมายเหตุ
Docs เป็นเว็บโหลดด้วย JavaScript + บางหน้าต้อง login — AI เปิดเองไม่ได้
วิธีเติม: user เปิดในเบราว์เซอร์ตัวเอง → copy เนื้อหา → วางเป็นไฟล์ใหม่ใน `automa-docs/` (หัวไฟล์กำกับ URL+วันที่แบบไฟล์เดิม)
